...
set_target_properties(libsoplex PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsoplex.a"
  )

list(APPEND _cmake_import_check_targets libsoplex )
list(APPEND _cmake_import_check_files_for_libsoplex "${_IMPORT_PREFIX}/lib64/libsoplex.a" )
...
set_target_properties(libsoplex-pic PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsoplex-pic.a"
  )

list(APPEND _cmake_import_check_targets libsoplex-pic )
list(APPEND _cmake_import_check_files_for_libsoplex-pic "${_IMPORT_PREFIX}/lib64/libsoplex-pic.a" )
...
set_target_properties(libsoplexshared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsoplexshared.so.7.1.2.0"
  IMPORTED_SONAME_RELEASE "libsoplexshared.so.7.1"
  )

list(APPEND _cmake_import_check_targets libsoplexshared )
list(APPEND _cmake_import_check_files_for_libsoplexshared "${_IMPORT_PREFIX}/lib64/libsoplexshared.so.7.1.2.0" )
